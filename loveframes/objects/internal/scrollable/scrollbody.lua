...
function newobject:initialize(parent, bartype)
	...
	table.insert(self.internals, loveframes.objects["scrollarea"](self, bartype))
	
	local bar = self.internals[1].internals[1]
	
	if self.bartype == "vertical" then 
		local upbutton = loveframes.objects["scrollbutton"]("up")
		...
		local downbutton = loveframes.objects["scrollbutton"]("down")
	...
	elseif self.bartype == "horizontal" then
		local leftbutton = loveframes.objects["scrollbutton"]("left")
		...
		local rightbutton = loveframes.objects["scrollbutton"]("right")
